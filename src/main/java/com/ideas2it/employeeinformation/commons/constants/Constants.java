...
public final class Constants {
    ...
    public static final String CLIENT_ADD_FAIL_EMAILID =
        "The Client NOT Added Emailid %s Already taken by other user";
    public static final String EMPLOYEE_ADD_FAIL_EMAILID =
        "The Employee NOT Added Emailid %s Already taken by other user";
    ...
    public static final String USER_SELECT_FAILED =
        "User %s not found";
    public static final String PROJECT_ADD_FAILED = 
        "Project cannot be Added due to some error.Try again Some time";
    public static final String PROJECT_SEARCH_FAILED = 
        "Project cannot be searched due to some Issues.Try again Some time";
    public static final String PROJECT_UPDATE_FAIL = 
        "Project Updation Failed Due to some Error.Try again Some time";
    public static final String PROJECT_DELETE_FAIL = 
        "Project Deletion cannot be Done due to some issue.Try again Some time";
    public static final String PROJECT_ACTIVATE_FAIL = 
        "Project cannot be Activated due to some Issues.Try again Some time";
    public static final String CLIENT_CANNOT_DISPLAYED = 
        "Client Information cannot be Displayed.Try again Some time";
    public static final String CLIENT_DETAILS_FAIL =
        "Sorry Client Details cannot be Displayed.Try again Some time";
    public static final String CLIENT_ADD_FAIL =
        "Sorry Client Details not added due to some error.Try again Some time";
    public static final String CLIENT_DISPLAY_FAIL =
        "Sorry Client Details cannot be Displayed.Try again Some time";
    public static final String CLIENT_ACTIVATE_FAIL =
        "Sorry Client cannot be Activated.Try again Some time";
    public static final String CLIENT_DELETE_FAIL =
        "Sorry Client cannot be Deleted.Try again Some time";
    public static final String CLIENT_UPDATE_FAIL =
        "Sorry Client Details cannot be updated.Try again Some time";
    public static final String GET_PROJECTS_FAIL =
        "Sorry Projects cannot be Displayed.Try again Some time";
    public static final String EMPLOYEE_ADD_FAILED =
        "Sorry Employee Details not added due to some error.Try again Some time";
    public static final String EMPLOYEE_SEARCH_FAIL =
        "Sorry Employee Details cannot be searched error.Try again Some time";
    public static final String EMPLOYEE_UPDATE_FAIL =
        "Sorry Employee Details not updated error.Try again Some time";
    public static final String EMPLOYEE_DELETE_FAIL =
        "Sorry Employee Details not deleted error.Try again Some time";
    public static final String EMPLOYEE_DISPLAY_FAIL =
        "Sorry Employee Details cannot be displayed error.Try again Some time";
    public static final String EMPLOYEE_ACTIVATE_FAIL =
        "Sorry Employee not Activated due to some error.Try again Some time";
    ...
    public static final String ACTIVATE_CLIENT = "/activateClient";
    ...
    public static final String INDEX_LOGIN_REQUEST = "/indexLogin";
    public static final String INVALID_REQUEST = "/*";
    public static final String DATE_FORMAT = "yyyy-MM-dd";
    public static final String SESSION_NOT_CLOSED =
        "Error Occurs when Closing the Session";
    public static final String SESSION_FACTORY_NOT_CREATED =
        "Error while created a Session Factory";
}
