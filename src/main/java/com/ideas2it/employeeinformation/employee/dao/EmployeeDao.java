...
public interface EmployeeDao {
     ...
     * @return  true when Employee added successfully else returns False.
     */
    ...
    /**
     * <p>
     * Method to inactivate the Existing Employee Object in the Database. The
     * Employee Object is fetched from EmployeeId and the Employee Object is
     * inactivated the Old Employee Details.
     * </p>
     *
     * @param  employee  Employee object contains the Employee details that
     *                   needs to be inactivated.
     * @return boolean  returns true when the Employee object is inactivated and
    ...
    /**
     * <p>
     * Method to Activate the Existing Employee Object in the Database. The
     * Employee Object is fetched from EmployeeId and the Employee Object is
     * Activated the Old Employee Details.
     * </p>
     *
     * @param   EmployeeId  a int datatype which contains the Employee
     *                      id that needs to be Activated.
     * @return boolean  returns true when the Employee object is Activated and
     *                  false if operation is failed.
