...
public class EmployeeController extends HttpServlet {
     ...
     */
    @RequestMapping(value = Constants.DELETE_EMPLOYEE, method = RequestMethod.GET)
     ...
     *                      with the Employee Object or to the Error Page.
     */
    @RequestMapping(value = Constants.SEARCH_EMPLOYEE, method = RequestMethod.GET)
    ...
    /**
     * <p>
     * This method is called when the request value is displayInActiveEmployee
     * and this is the Get method which gets all the Employee Object Details and
     * is displayed to the user. It is redirected to the Display Employee page
     * or to the Error page if any error occurs.This method returns the value as 
     * ModelAndView Class Object.
     * </p>
     *
     * @return ModelAndView Object which redirects to the DisplayEmployee Page
     *                      with the EmployeeObject List or to the Error Page.
     */
    @RequestMapping(value = Constants.DISPLAY_INACTIVE_EMPLOYEE, method = RequestMethod.GET)
    private ModelAndView displayInActiveEmployees() {
        try {
     ...
     *                      with the EmployeeObject or to the Error Page.
     */
    @RequestMapping(value=Constants.ACTIVATE_EMPLOYEE, method = RequestMethod.GET)
